...
export const faqItems = [
    {
        ...
        a: "Eine KI Unternehmensanalyse ist eine systematische Bewertung des KI-Reifegrads eines Unternehmens. Sie untersucht in sechs Dimensionen, wie gut ein Unternehmen auf den Einsatz von Künstlicher Intelligenz vorbereitet ist — von der strategischen Verankerung über die Dateninfrastruktur bis hin zu Mitarbeiterkompetenzen und Budget. Das Ergebnis ist ein Score von 0 bis 100 mit konkreten Handlungsempfehlungen.",
    },
    {
        q: "Was bringt eine KI Unternehmensanalyse meinem Unternehmen?",
        a: "Die KI Unternehmensanalyse zeigt Ihnen objektiv, wo Ihr Unternehmen beim Einsatz von KI steht, welche Automatisierungspotenziale bestehen und wie hoch Ihr Einsparpotenzial durch KI ist. Sie erhalten konkrete, sofort umsetzbare Empfehlungen — priorisiert nach Wirkung und Aufwand. So vermeiden Sie teure Fehlinvestitionen und starten gezielt mit den richtigen KI-Projekten.",
    },
    {
        q: "Was ist der Unterschied zwischen KI Unternehmensanalyse und KI Readiness Check?",
        a: "Die Begriffe KI Unternehmensanalyse, KI Readiness Check und KI Reifegrad Analyse werden häufig synonym verwendet. Alle beschreiben eine strukturierte Bewertung der KI-Reife eines Unternehmens. Unser Tool auf ki-unternehmensanalyse.de kombiniert alle drei Dimensionen: IST-Zustand-Analyse (Readiness), Reifegrad-Bewertung (Maturity Score) und konkrete Handlungsempfehlungen (Analyse).",
    },
    {
    ...
    {
        q: "Wie lange dauert die KI Unternehmensanalyse?",
    ...
    {
        q: "Ist die KI Unternehmensanalyse wirklich kostenlos?",
        a: "Ja, die KI Unternehmensanalyse auf ki-unternehmensanalyse.de ist zu 100 % kostenlos und unverbindlich. Sie können Ihre Ergebnisse sofort einsehen. Es entstehen keine versteckten Kosten. Optional können Sie ein kostenloses Beratungsgespräch buchen, um die Ergebnisse persönlich zu besprechen.",
    },
    {
        q: "Für welche Unternehmen eignet sich die KI Analyse?",
        a: "Die KI Unternehmensanalyse richtet sich an Unternehmen aller Branchen und Größen im deutschsprachigen Raum — von Produktion und Handel über Dienstleistungen bis hin zu IT und Gesundheit. Besonders geeignet für Unternehmen mit 10 bis 1.000 Mitarbeitenden, die ihre KI-Strategie aufbauen oder bestehende Ansätze systematisch bewerten möchten.",
    },
    {
        q: "Was kostet die Einführung von KI im Mittelstand?",
        a: "Die Kosten variieren stark je nach Umfang und Branche. Erste KI-Tools (ChatGPT, Copilot) können bereits ab wenigen hundert Euro pro Monat eingesetzt werden. Strategische KI-Projekte mit individueller Anpassung liegen typischerweise zwischen 10.000 und 100.000 Euro. Unsere KI Unternehmensanalyse hilft Ihnen, die richtigen Prioritäten zu setzen, bevor Sie investieren.",
    },
    {
    ...
    {
        q: "Was passiert nach der KI Unternehmensanalyse?",
...
export const howToSteps = [
    {
        ...
        text: "Beantworten Sie 10 kurze Abschnitte zu Ihrem Unternehmen, KI-Status, Prozessen, Daten, Marketing, Mitarbeiterkompetenzen und Budget. Die KI Unternehmensanalyse dauert etwa 5 Minuten.",
        icon: "📋",
    },
    {
