...
export default function HeroSection({ onStartCheck }: HeroSectionProps) {
    ...
    return (
        <div>
            ...
            {/* ═══════════════════════════════════════════════
                TRUST SECTION — Why a KI Beratung KMU
            ═══════════════════════════════════════════════ */}
            <section className="mx-auto max-w-5xl px-4 pb-16 sm:px-6">
                <motion.h2
                    className="mb-8 text-center font-headline text-2xl font-bold text-brand-black sm:text-3xl"
                    ...
                    {[
                        {
                            ...
                            text: "Unsere KI Beratung KMU liefert eine objektive Einschätzung, wo Ihr Unternehmen beim Einsatz von Künstlicher Intelligenz steht — wissenschaftlich fundiert und branchenspezifisch.",
                        },
                        {
                            icon: "🔍",
            ...
            {/* ═══════════════════════════════════════════════
                GEO POWER SECTION — KI Beratung KMU Deep Dive
            ...
            {/* ═══════════════════════════════════════════════
                HOW-TO SECTION — So funktioniert die KI Beratung KMU
                ~300 words
            ═══════════════════════════════════════════════ */}
            <section className="mx-auto max-w-5xl px-4 pb-16 sm:px-6">
                <motion.h2
                    ...
                    viewport={{ once: true }} transition={{ duration: 0.5 }}
                >
                    So funktioniert die KI Beratung KMU
                </motion.h2>
            ...
            <section className="mx-auto max-w-5xl px-4 pb-16 sm:px-6">
                <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
                    ...
                    <h2 className="mb-8 text-center font-headline text-2xl font-bold text-brand-black sm:text-3xl">
                        6 Dimensionen der KI Beratung KMU
                    </h2>
                ...
                <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        {[
                            ...
                            { value: "5 Min.", label: "für Ihre persönliche KI Beratung KMU", source: "" },
                        ].map((stat, i) => (
                            <motion.div
                                key={i}
                    ...
                    <div className="mt-6 space-y-4 text-gray-600 leading-relaxed">
                        <p>
                            Deutschland ist Europas größte Volkswirtschaft — und der Mittelstand ihr Motor. Doch bei der KI-Adoption hinken mittelständische Unternehmen den Konzernen hinterher. Während 78 Prozent der DAX-Unternehmen bereits KI-Strategien implementiert haben, fehlt im Mittelstand häufig der strukturierte Einstieg. Die Herausforderungen sind bekannt: Fachkräftemangel, steigende Kosten und zunehmender Wettbewerbsdruck. Eine professionelle KI Beratung KMU kann bei all diesen Themen ein entscheidender Hebel sein — vorausgesetzt, der Einstieg wird richtig priorisiert.
                        </p>
                        <p>
                            Unternehmen, die ihren KI-Reifegrad systematisch analysieren, investieren gezielter und vermeiden typische Fehler bei der Einführung. Der häufigste Fehler: in teure Individuallösungen investieren, bevor die Grundlagen stimmen. Unsere kostenlose KI Beratung KMU auf ki-beratung-kmu.de zeigt Ihnen in 5 Minuten, wo Sie stehen und was der effektivste nächste Schritt ist.
                        </p>
                    </div>
                </motion.div>
            </section>
            ...
            <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6">
                <motion.h2
                    ...
                    viewport={{ once: true }} transition={{ duration: 0.5 }}
                >
                    Häufige Fragen zur KI Beratung KMU
                </motion.h2>
            ...
            <section className="mx-auto max-w-4xl px-4 pb-20 sm:px-6">
                ...
                >
                    <h2 className="font-headline text-2xl font-bold sm:text-3xl">
                        Bereit für Ihre kostenlose KI Beratung KMU?
                    </h2>
